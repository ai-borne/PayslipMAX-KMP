...
**Status:** Phases 0-4 done (12 Aug 2026); Phase 5 next
...
### Phase 7 — Debt removal, copy correctness, disclaimers (D13, D16, D17)
...
**Acceptance.** No dead tax code. `docs/AI_INSIGHTS_PIPELINE.md` updated with the two-track model and a changelog
entry.
