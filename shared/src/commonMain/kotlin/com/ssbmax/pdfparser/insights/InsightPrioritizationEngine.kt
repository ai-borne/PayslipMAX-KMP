...
object InsightPrioritizationEngine {
    fun prioritize(
        ...
        val scoredList = anomalies.map { anomaly ->
    ...
    private fun getImportance(type: String, amount: Double): Int {
        return when (type) {
            "SALARY_LOSS" -> 9
    ...
    private fun getNovelty(type: String, previousAnomalies: List<Anomaly>): Int {
