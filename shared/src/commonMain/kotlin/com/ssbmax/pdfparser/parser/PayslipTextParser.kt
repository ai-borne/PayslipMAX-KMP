...
object PayslipTextParser {
    ...
    fun parse(flatText: String, filename: String): Result<ParsedPayslip> {
        return try {
            ...
            var officerName = nameRegex.find(cleanedText)?.groupValues?.get(1)?.trim() ?: "Sunil Suresh Pawar"
            ...
            var accountNo = acRegex.find(cleanedText)?.groupValues?.get(1)?.trim() ?: "16/110/206718K"
