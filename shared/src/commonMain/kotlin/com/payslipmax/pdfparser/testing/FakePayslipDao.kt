...
class FakePayslipDao : PayslipDao {
    ...
    private val settingsDatabase = MutableStateFlow<com.payslipmax.pdfparser.database.AppSettingsEntity?>(null)

    override fun getSettingsFlow(): Flow<com.payslipmax.pdfparser.database.AppSettingsEntity?> {
        return settingsDatabase
    }

    override suspend fun getSettings(): com.payslipmax.pdfparser.database.AppSettingsEntity? {
