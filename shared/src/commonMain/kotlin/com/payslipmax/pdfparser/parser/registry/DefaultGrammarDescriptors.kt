...
object DefaultGrammarDescriptors {
    val LEGACY_STATEMENT =
        GrammarDescriptor(
            ...
            strategySet = com.payslipmax.pdfparser.parser.strategy.legacy.LegacyStatementStrategySet,
        )
    ...
    val EARLY_DUAL_COL =
        GrammarDescriptor(
            ...
            strategySet = com.payslipmax.pdfparser.parser.strategy.legacy.EarlyDualColStrategySet,
        )
    ...
    val TRANSITIONAL_7TH_CPC =
        GrammarDescriptor(
            ...
            strategySet = com.payslipmax.pdfparser.parser.strategy.transitional.Transitional7thCpcStrategySet,
        )
    ...
    val MODERN_GRID =
        GrammarDescriptor(
            ...
            strategySet = com.payslipmax.pdfparser.parser.strategy.modern.ModernGridStrategySet,
    ...
    val EXTENDED_GRID =
        GrammarDescriptor(
            ...
            strategySet = com.payslipmax.pdfparser.parser.strategy.modern.ExtendedGridStrategySet,
            verificationMatcher = { tokenized -> matchGridStructural(tokenized) },
        )
     ...
     * [com.payslipmax.pdfparser.parser.detection.GrammarEraMapper]); an incidental marker like "ARR-" varies
