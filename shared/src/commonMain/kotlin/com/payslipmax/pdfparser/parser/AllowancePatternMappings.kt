...
object AllowancePatternMappings {
    ...
    val fieldAndRiskMappings: Map<String, String> =
        mapOf(
            ...
            "RHA" to "riskHardshipAllowance",
            "ARR-RHA" to "arrearsRiskHardship",
            ...
            "R1H1" to "riskHardshipAllowance",
            "R1H2" to "riskHardshipAllowance",
            "R1H3" to "riskHardshipAllowance",
            "R2H1" to "riskHardshipAllowance",
            "R2H2" to "riskHardshipAllowance",
            "R2H3" to "riskHardshipAllowance",
            "R3H1" to "riskHardshipAllowance",
            "R3H2" to "riskHardshipAllowance",
            "R3H3" to "riskHardshipAllowance",
            "ARR-R1H1" to "arrearsRiskHardship",
            "ARR-R1H2" to "arrearsRiskHardship",
            "ARR-R1H3" to "arrearsRiskHardship",
            "ARR-R2H1" to "arrearsRiskHardship",
            "ARR-R2H2" to "arrearsRiskHardship",
            "ARR-R2H3" to "arrearsRiskHardship",
            "ARR-R3H1" to "arrearsRiskHardship",
            "ARR-R3H2" to "arrearsRiskHardship",
            "ARR-R3H3" to "arrearsRiskHardship",
            "HAFA" to "fieldAllowance",
            "HAFAA" to "fieldAllowance",
            "CFAA" to "fieldAllowance",
            "CMFAA" to "fieldAllowance",
            "ARR-HAFA" to "fieldAllowance",
            "ARR-HAFAA" to "fieldAllowance",
            "ARR-CFAA" to "fieldAllowance",
            "ARR-CMFAA" to "fieldAllowance",
            "HAUCA" to "riskHardshipAllowance",
            "HUACA" to "riskHardshipAllowance",
            "SCCIA" to "riskHardshipAllowance",
            "SIACHEN" to "riskHardshipAllowance",
            "ARR-HAUCA" to "arrearsRiskHardship",
            "ARR-HUACA" to "arrearsRiskHardship",
            "ARR-SCCIA" to "arrearsRiskHardship",
            "ARR-SIACHEN" to "arrearsRiskHardship",
    ...
    val adjustmentAndLedgerMappings: Map<String, String> =
        mapOf(
            ...
            "LVELTC" to "adjPayAndAllce",
            "ARR-LVELTC" to "adjPayAndAllce",
            "A/o LVELTC" to "adjPayAndAllce",
            "LVENCASH" to "adjPayAndAllce",
            "ARR-LVENCASH" to "adjPayAndAllce",
