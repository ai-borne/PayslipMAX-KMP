...
class PayslipDaoTest {
    ...
    @Test
    fun testLedgerRecordOperations() = runTest {
        val record = LedgerRecordEntity(
            dateStr = "05/2026",
            year = 2026,
            monthNum = 5,
            basicPay = 105300.0,
    ...
    @Test
    fun testFinancialInsightOperations() = runTest {
        val insight = FinancialInsightEntity(
            id = "insight_05_2026",
            monthStr = "05/2026",
            category = "ALLOWANCE",
            title = "Missing HRA",
    ...
    @Test
    fun testRepresentationDraftOperations() = runTest {
        val draft = RepresentationDraftEntity(
