 ...
 * (token-content in [com.payslipmax.pdfparser.parser.TokenParityDiffTest], structured-field in
 * [com.payslipmax.pdfparser.parser.IosTokenParseCorpusRegressionTest]) so the quarantine reasoning lives
