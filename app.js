...
function updatePayslipReplica(record) {
  ...
  document.getElementById("replica-name").textContent = `Name: ${record.officer.name || 'SUNIL SURESH PAWAR'}`;
  document.getElementById("replica-cda").textContent = `CDA: ${record.officer.account_no || '16/110/206718K'}`;
