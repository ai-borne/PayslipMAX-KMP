...
class TaxPlannerViewStateTest {
    ...
    private fun makeOptResult(vararg opps: Opportunity) = OptimizationResult(
    ...
    private fun opp(id: String, title: String, unused: Double, taxSaved: Double) =
    ...
    fun testMultipleOpportunitiesPreserveOrder() {
        val items = buildTaxOptViewItems(
            makeOptResult(
