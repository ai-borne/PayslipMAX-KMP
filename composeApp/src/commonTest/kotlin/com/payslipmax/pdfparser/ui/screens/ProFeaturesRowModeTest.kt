 ...
 * user navigates into a PRO feature or is shown the upgrade sheet. DSOP_SIMULATOR (Phase 4b) is the
 * worked example: it carries a navigation [ProFeatureMeta.target] (RetirementPlanning), so the only
