...
object AppStrings {
    ...
    const val settingsProfileHeader = "Officer Profile Settings"
    const val settingsProfileDesc = "Set default identity details for dashboard and replica personalization."
    const val settingsProfileRowSubtitleUnconfigured = "Set name, CDA & PAN to personalize dashboard & replicas"
    ...
    const val settingsBackupPasswordLabel = "Backup Password"
    const val settingsBackupPasswordHint = "Any combination of letters, numbers, and symbols allowed. Cannot be recovered if forgotten."
    const val settingsBackupPasswordPlaceholder = "e.g. Pass123! or passphrase"
    ...
    const val settingsRowProfileLabel = "Officer Profile"
