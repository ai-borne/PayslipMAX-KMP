...
object InsightsStrings {
    ...
    const val wellnessDsopNonCompliance = "Increase DSOP subscription to mandatory 6% minimum"
    const val wellnessDsopOptimizeCap = "Increase DSOP subscription towards ₹5 Lakhs tax-free cap"
