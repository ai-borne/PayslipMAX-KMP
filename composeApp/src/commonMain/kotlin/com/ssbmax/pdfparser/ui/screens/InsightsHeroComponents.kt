...
@Composable
private fun RecoveryCtaButton(label: String, isPremiumEnabled: Boolean, onClick: () -> Unit) {
    Button(
        onClick = onClick,
        modifier = Modifier.fillMaxWidth(),
...
@Composable
private fun WealthCtaButton(label: String, isPremiumEnabled: Boolean, onClick: () -> Unit) {
    OutlinedButton(
        onClick = onClick,
        modifier = Modifier.fillMaxWidth(),
