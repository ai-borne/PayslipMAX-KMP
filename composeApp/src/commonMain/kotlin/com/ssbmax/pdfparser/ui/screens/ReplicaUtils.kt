 ...
 * (see [com.ssbmax.pdfparser.parser.ReconciliationSolver.route]) — an item is never in both. So the
 ...
 */
private fun structuredCreditLines(earnings: com.ssbmax.pdfparser.domain.Earnings): List<LedgerLine> =
    listOf(
...
private fun structuredDebitLines(deductions: com.ssbmax.pdfparser.domain.Deductions): List<LedgerLine> =
    listOf(
